"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([[7058,4240,9469,197],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ AntdRadarController)
/* harmony export */ });
...
class AntdRadarController extends _antd_common_AntdBaseDesignerController__WEBPACK_IMPORTED_MODULE_1__.AntdBaseDesignerController{async create(container,config){super.commonCreate(container,_antv_g2plot__WEBPACK_IMPORTED_MODULE_0__.Radar,config);}destroy(){this.instance.destroy();this.instance=null;this.config=null;this.interval&&clearInterval(this.interval);}getConfig(){return this.config;}changeData(data){var _this$instance;this.config.data.staticData=data;this.config.style.data=data;(_this$instance=this.instance)===null||_this$instance===void 0?void 0:_this$instance.changeData(data);}update(config,upOp){super.commonUpdate(config,_antv_g2plot__WEBPACK_IMPORTED_MODULE_0__.Radar,upOp);}updateTheme(newTheme){}}
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ radar_AntdRadarDefinition)
});
...
;// ./src/pages/Charts/comps/antd/radar/radar.png
const radar_namespaceObject = __webpack_require__.p + "static/media/radar.2a15997820a18829826b.png";
// EXTERNAL MODULE: ./src/pages/Charts/comps/antd/radar/AntdRadarController.ts
var AntdRadarController = __webpack_require__(14240);
...
;// ./src/pages/Charts/comps/antd/radar/AntdRadarDefinition.ts
const AnimationConfig=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 62).then(__webpack_require__.bind(__webpack_require__, 80062)));const AntdRadarStyleConfig=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 4483).then(__webpack_require__.bind(__webpack_require__, 14483)));const ThemeConfig=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 8458).then(__webpack_require__.bind(__webpack_require__, 28458)));const BaseInfo=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 6676).then(__webpack_require__.bind(__webpack_require__, 76676)));const DataConfig=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 3439).then(__webpack_require__.bind(__webpack_require__, 13439)));const AntdRadarFieldMapping=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 4483).then(__webpack_require__.bind(__webpack_require__, 14483)).then(module=>({default:module.AntdRadarFieldMapping})));class AntdRadarDefinition extends AntdCommonDefinition.AntdCommonDefinition{getController(){return AntdRadarController["default"];}getMenuList(){return (0,util.getDefaultMenuList)();}getMenuToConfigContentMap(){return{base:BaseInfo,data:DataConfig,style:AntdRadarStyleConfig,animation:AnimationConfig,theme:ThemeConfig,mapping:AntdRadarFieldMapping};}getBaseInfo(){return{compName:"Antd雷达图",compKey:"AntdRadar",categorize:"chart",subCategorize:"radar"};}getChartImg(){return radar_namespaceObject;}getInitConfig(){const data=[{name:"G2",star:10371},{name:"G6",star:7380},{name:"F2",star:7414},{name:"L7",star:2140},{name:"X6",star:6601},{name:"AVA",star:8851},{name:"G2Plot",star:1626}];return{base:{id:"",name:'Antd雷达图',type:'AntdRadar'},style:{data:data,xField:"name",yField:"star",radius:1,smooth:true,lineStyle:{stroke:"#8fe0ff",lineWidth:2,opacity:0.5},point:{size:3,shape:"circle",style:{fill:"#4c9cff",stroke:"#64d6ff",lineWidth:1}},area:{style:{fill:"#3991ff",fillOpacity:0.6}},xAxis:{line:null,tickLine:null,grid:{alignTick:true,line:{style:{stroke:"#42cdffbb",lineWidth:1},type:"line"}},label:{style:{fill:"#41bbff"}}},yAxis:{line:{style:{stroke:"#595959",lineWidth:1}},tickLine:null,grid:{alignTick:true,line:{style:{stroke:"#7ee5ff95",lineWidth:1},type:"line"}},label:{style:{fill:"#78b3fa"}}},animation:{appear:{animation:"wave-in",duration:3000}}},data:{sourceType:'static',staticData:data}};}}/* harmony default export */ const radar_AntdRadarDefinition = (AntdRadarDefinition);
