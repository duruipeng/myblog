"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([[2512,5554,7493,6273],{
...
var carousel = __webpack_require__(87991);
...
;// ./src/pages/Charts/comps/lc/carousel/CarouselComponent.less
...
;// ./src/pages/Charts/comps/lc/carousel/CarouselComponent.tsx
...
/* harmony import */ var _CarouselComponent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5554);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ CarouselDefinition)
/* harmony export */ });
/* harmony import */ var _carousel_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(30959);
/* harmony import */ var _CarouselController__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(76273);
/* harmony import */ var _CarouselConfig__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(57493);
/* harmony import */ var _framework_core_AbstractDesignerDefinition__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(64069);
class CarouselDefinition extends _framework_core_AbstractDesignerDefinition__WEBPACK_IMPORTED_MODULE_3__["default"]{getBaseInfo(){return{compName:"轮播图",compKey:"carousel",categorize:"web"};}getChartImg(){return _carousel_png__WEBPACK_IMPORTED_MODULE_0__;}getController(){return _CarouselController__WEBPACK_IMPORTED_MODULE_1__.CarouselController;}getInitConfig(){return{base:{id:"",name:'轮播图',type:'carousel'},style:{autoplay:true,autoplaySpeed:3000,dots:true,fade:false,speed:500},filter:{enable:false,blur:0,brightness:1,contrast:1,opacity:1,saturate:1,hueRotate:0},data:{sourceType:'static',staticData:[_carousel_png__WEBPACK_IMPORTED_MODULE_0__,_carousel_png__WEBPACK_IMPORTED_MODULE_0__]}};}getMenuList(){return super.getMenuList().filter(item=>item.key!=='theme');}getMenuToConfigContentMap(){const menuMapping=super.getMenuToConfigContentMap();menuMapping['style']=_CarouselConfig__WEBPACK_IMPORTED_MODULE_2__.CarouselConfig;return menuMapping;}getEventList(){const events=super.getEventList();return events.concat([{id:"click",name:"点击时"}]);}}
