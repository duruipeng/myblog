"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([[1666,6689,5204,5786],{
...
/* harmony import */ var _BaseVideoComponent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(86689);
...
var BaseVideoController = __webpack_require__(95786);
;// ./src/pages/Charts/comps/lc/base-video/baseVideo.png
...
var BaseVideoConfig = __webpack_require__(75204);
...
;// ./src/pages/Charts/comps/lc/base-video/BaseVideoDefinition.ts
const BaseInfo=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 4295).then(__webpack_require__.bind(__webpack_require__, 76676)));const FilterConfig=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 2017).then(__webpack_require__.bind(__webpack_require__, 4398)));class BaseVideoDefinition extends AbstractDesignerDefinition["default"]{getBaseInfo(){return{compName:"视频",compKey:"BaseVideo",categorize:"media"};}getChartImg(){return baseVideo_namespaceObject;}getController(){return BaseVideoController["default"];}getInitConfig(){return{base:{id:"",name:'视频',type:'BaseVideo'},style:{src:undefined},filter:{enable:false,blur:0,brightness:1,contrast:1,opacity:1,saturate:1,hueRotate:0}};}getMenuList(){return super.getMenuList().filter(item=>item.key!=='theme'&&item.key!=='data');}getMenuToConfigContentMap(){return{base:BaseInfo,style:BaseVideoConfig.BaseVideoStyleConfig,filter:FilterConfig};}getEventList(){const events=super.getEventList();return events.concat([{id:"click",name:"点击时"}]);}}
