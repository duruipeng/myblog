"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([[2247,868,4078,3702],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AntdBarCommonStyleConfig: () => (/* binding */ AntdBarCommonStyleConfig),
/* harmony export */   AntdBarFieldMapping: () => (/* binding */ AntdBarFieldMapping),
/* harmony export */   AntdBarGraphics: () => (/* binding */ AntdBarGraphics)
/* harmony export */ });
...
class AntdBarCommonStyleConfig extends react__WEBPACK_IMPORTED_MODULE_0__.Component{constructor(){super(...arguments);this.barCoordinateSysChange=config=>{const controller=this.props.controller;controller.update({style:config});};}render(){const{controller}=this.props;const config=controller.getConfig().style;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.Fragment,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(AntdBarGraphics,{controller:controller}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_config_legend_AntdLegend__WEBPACK_IMPORTED_MODULE_3__.AntdLegend,{controller:controller}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_config_AntdFragment__WEBPACK_IMPORTED_MODULE_1__.AntdCartesianCoordinateSys,{onChange:this.barCoordinateSysChange,config:config})]});}}const AntdBarGraphics=_ref=>{var _config$barStyle;let{controller}=_ref;const config=controller.getConfig().style;const onFieldChange=fieldChangeData=>{const{id,data,dataFragment}=fieldChangeData;if(id==='barColor'){if(data&&Array.isArray(data)){controller.update({style:{color:data,barStyle:{fill:undefined}}});}else if(data&&typeof data==='string'&&data.indexOf('gradient')!==-1){//渐变
}else{controller.update({style:{barStyle:{fill:data}}});}}else{controller.update(dataFragment);}};const schema={key:'style',type:'accordion',label:'图形',children:[{type:'grid',config:{columns:2},children:[{key:'maxBarWidth',type:'number-input',label:'宽度',value:config===null||config===void 0?void 0:config.maxBarWidth,config:{min:1,max:100}},{key:'barStyle',children:[{key:'radius',type:'number-input',label:'圆角',value:config===null||config===void 0?void 0:(_config$barStyle=config.barStyle)===null||_config$barStyle===void 0?void 0:_config$barStyle.radius,config:{min:1,max:100}}]},{id:'barColor',type:'color-mode',label:'颜色',value:config===null||config===void 0?void 0:config.color,config:{containerStyle:{gridColumn:'1/3'}}}]}]};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_json_schema_LCGUI__WEBPACK_IMPORTED_MODULE_2__.LCGUI,{schema:schema,onFieldChange:onFieldChange});};const AntdBarFieldMapping=_ref2=>{let{controller}=_ref2;const config=controller.getConfig().style;const{data,xField,yField,seriesField}=config;const options=[];if(data&&data.length>=1){const dataObj=data[0];Object.keys(dataObj).forEach(key=>options.push({label:key,value:key}));}const fieldChange=fieldChangeData=>{controller.update(fieldChangeData.dataFragment);};const schema={key:'style',type:'grid',config:{columns:2},children:[{key:'xField',type:'select',label:'X字段',value:xField,config:{options}},{key:'yField',type:'select',label:'Y字段',value:yField,config:{options}},{key:'seriesField',type:'select',label:'分组字段',value:seriesField,config:{options}}]};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_json_schema_LCGUI__WEBPACK_IMPORTED_MODULE_2__.LCGUI,{schema:schema,onFieldChange:fieldChange});};
