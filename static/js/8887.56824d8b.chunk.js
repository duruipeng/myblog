"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([[8887],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ canvas_DesignerRuler)
});

// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(48331);
// EXTERNAL MODULE: ./node_modules/framework-utils/dist/utils.esm.js
var utils_esm = __webpack_require__(8773);
// EXTERNAL MODULE: ./node_modules/@daybrush/utils/dist/utils.esm.js
var dist_utils_esm = __webpack_require__(28205);
;// CONCATENATED MODULE: ./node_modules/@scena/react-ruler/dist/ruler.esm.js
/*
...
function (_super) {
  ...
  __proto.render = function () {
    ...
    return (0,react.createElement)("canvas", {
      ref: (0,utils_esm.ref)(this, "canvasElement"),
  ...
  __proto.draw = function (scrollPos, nextZoom) {
    ...
    var mainLineSize = (0,dist_utils_esm.convertUnitSize)("".concat(props.mainLineSize || "100%"), containerSize);
    var longLineSize = (0,dist_utils_esm.convertUnitSize)("".concat(props.longLineSize || 10), containerSize);
    var shortLineSize = (0,dist_utils_esm.convertUnitSize)("".concat(props.shortLineSize || 7), containerSize);
      ...
      selectedRanges.forEach(function (selectedRange) {
        ...
        if (selectedRangesText) {
          selectedRange.forEach(function (value) {
            ...
            (0,dist_utils_esm.findLast)(values, function (_a, index) {
...
/* harmony default export */ const ruler_esm = (Ruler);
...
// EXTERNAL MODULE: ./src/pages/Charts/designer/left/DesignerLeftStore.ts
var DesignerLeftStore = __webpack_require__(918);
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(7579);
;// CONCATENATED MODULE: ./src/pages/Charts/designer/canvas/DesignerRuler.tsx
/**
 * 缩放计算公式：
 * 设现有条件：
 * 1) 当前鼠标位置：P
 ...
 */const DesignerRuler=/*#__PURE__*/(0,react.memo)(props=>{const[,setCount]=(0,react.useState)(0);const rulerXRef=(0,react.useRef)(null);const rulerYRef=(0,react.useRef)(null);const unitRef=(0,react.useRef)(50);const scrollPosRef=(0,react.useRef)({x:0,y:0});const baseOffsetRef=(0,react.useRef)(20);const ruleWheel=()=>{const{scale}=EventOperateStore["default"];const{dsContentRef}=EventOperateStore["default"];const{designerLeftRef}=DesignerLeftStore["default"];const{x,y}=dsContentRef===null||dsContentRef===void 0?void 0:dsContentRef.getBoundingClientRect();const{width}=designerLeftRef===null||designerLeftRef===void 0?void 0:designerLeftRef.getBoundingClientRect();scrollPosRef.current.x=-(x-width-20)/scale;scrollPosRef.current.y=-(y-70)/scale;unitRef.current=Math.floor(50/scale);setCount(Date.now());};//todo 数字魔法值要统一公共变量处理
const ruleDrag=()=>{const{dsContentRef,scale}=EventOperateStore["default"];const{designerLeftRef}=DesignerLeftStore["default"];const{x,y}=dsContentRef===null||dsContentRef===void 0?void 0:dsContentRef.getBoundingClientRect();const{width}=designerLeftRef===null||designerLeftRef===void 0?void 0:designerLeftRef.getBoundingClientRect();scrollPosRef.current.x=-(x-width-20)/scale;scrollPosRef.current.y=-(y-70)/scale;rulerXRef.current&&rulerXRef.current.scroll(scrollPosRef.current.x);rulerYRef.current&&rulerYRef.current.scroll(scrollPosRef.current.y);};(0,react.useEffect)(()=>{const{setRuleRef}=EventOperateStore["default"];setRuleRef({ruleWheel,ruleDrag});return()=>{setRuleRef(null);};},[]);const{scale}=EventOperateStore["default"];return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:'lc-ruler',style:{position:'relative'},children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{style:{position:'absolute',width:20,height:20,color:'#838383',textAlign:'center',fontSize:12,top:-1},children:"px"}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:'lc-ruler-horizontal',style:{height:baseOffsetRef.current,width:`calc(100% - ${baseOffsetRef.current}px)`,position:'relative',left:baseOffsetRef.current},children:/*#__PURE__*/(0,jsx_runtime.jsx)(ruler_esm,{ref:rulerXRef,scrollPos:scrollPosRef.current.x,zoom:scale,lineColor:'#444b4d',textColor:'#a6a6a6',segment:2,negativeRuler:true,textOffset:[0,10],backgroundColor:'#1f1f1f',unit:unitRef.current})}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:'lc-ruler-vertical',style:{width:baseOffsetRef.current,height:window.innerHeight-baseOffsetRef.current-90,position:'relative',overflow:'hidden'},children:/*#__PURE__*/(0,jsx_runtime.jsx)(ruler_esm,{ref:rulerYRef,type:'vertical',scrollPos:scrollPosRef.current.y,lineColor:'#444b4d',textColor:'#a6a6a6',zoom:scale,segment:2,negativeRuler:true,textOffset:[10,0],backgroundColor:'#1f1f1f',unit:unitRef.current})}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:'lc-ruler-content',style:{position:'absolute',overflow:'hidden',top:baseOffsetRef.current,left:baseOffsetRef.current},children:props.children})]});});/* harmony default export */ const canvas_DesignerRuler = (DesignerRuler);
