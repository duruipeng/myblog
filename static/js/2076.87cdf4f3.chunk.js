"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([[2076,1172,9469,197],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ AntdPieController)
/* harmony export */ });
...
class AntdPieController extends _antd_common_AntdBaseDesignerController__WEBPACK_IMPORTED_MODULE_1__.AntdBaseDesignerController{async create(container,config){super.commonCreate(container,_antv_g2plot__WEBPACK_IMPORTED_MODULE_0__.Pie,config);}destroy(){this.instance.destroy();this.instance=null;this.config=null;this.interval&&clearInterval(this.interval);}getConfig(){return this.config;}update(config,upOp){super.commonUpdate(config,_antv_g2plot__WEBPACK_IMPORTED_MODULE_0__.Pie,upOp);}updateTheme(newTheme){var _this$config,_styleConfig$legend$i,_styleConfig$legend$i2,_styleConfig$label,_styleConfig$statisti,_styleConfig$statisti2;if(!newTheme)return;const styleConfig=(_this$config=this.config)===null||_this$config===void 0?void 0:_this$config.style;const{colors:{main,mainText,supplementSecond,background,supplementFirst,subText}}=newTheme;//图形
...
if(styleConfig!==null&&styleConfig!==void 0&&styleConfig.pieStyle&&styleConfig!==null&&styleConfig!==void 0&&styleConfig.pieStyle)styleConfig.pieStyle.stroke=background;//标签
if(styleConfig!==null&&styleConfig!==void 0&&styleConfig.label&&styleConfig!==null&&styleConfig!==void 0&&(_styleConfig$label=styleConfig.label)!==null&&_styleConfig$label!==void 0&&_styleConfig$label.style)styleConfig.label.style.fill=mainText;//标题
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ pie_AntdPieDefinition)
});

// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(37995);
// EXTERNAL MODULE: ./src/pages/Charts/designer/right/util.ts
var util = __webpack_require__(62718);
;// ./src/pages/Charts/comps/antd/pie/pie.png
const pie_namespaceObject = __webpack_require__.p + "static/media/pie.c4b2b79b5b62c728baec.png";
// EXTERNAL MODULE: ./src/pages/Charts/comps/antd/pie/AntdPieController.ts
var AntdPieController = __webpack_require__(11172);
...
;// ./src/pages/Charts/comps/antd/pie/AntdPieDefinition.ts
const AnimationConfig=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 62).then(__webpack_require__.bind(__webpack_require__, 80062)));const AntdPieConfig=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 2231).then(__webpack_require__.bind(__webpack_require__, 72231)));const AntdPieFieldMapping=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 2231).then(__webpack_require__.bind(__webpack_require__, 72231)).then(module=>({default:module.AntdPieFieldMapping})));const ThemeConfig=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 8458).then(__webpack_require__.bind(__webpack_require__, 28458)));const BaseInfo=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 6676).then(__webpack_require__.bind(__webpack_require__, 76676)));const DataConfig=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 3439).then(__webpack_require__.bind(__webpack_require__, 13439)));class AntdPieDefinition extends AntdCommonDefinition.AntdCommonDefinition{getController(){return AntdPieController["default"];}getMenuList(){return (0,util.getDefaultMenuList)();}getMenuToConfigContentMap(){return{base:BaseInfo,data:DataConfig,style:AntdPieConfig,animation:AnimationConfig,theme:ThemeConfig,mapping:AntdPieFieldMapping};}getBaseInfo(){return{compName:"Antd饼图",compKey:"AntdPie",categorize:"chart",subCategorize:"pie"};}getChartImg(){return pie_namespaceObject;}getInitConfig(){const data=[{type:'sort1',value:30},{type:'sort2',value:25},{type:'sort3',value:20},{type:'sort4',value:25}];return{base:{id:"",name:'Antd饼图',type:'AntdPie'},style:{data,angleField:"value",colorField:"type",radius:0.7,innerRadius:0.6,startAngle:0,endAngle:Math.PI*2,pieStyle:{stroke:"#fff",lineWidth:0},label:{type:"outer",offset:27,content:"{name} {percentage}",autoRotate:true,rotate:0,style:{textAlign:"center",fontSize:10,fontWeight:400,fill:"#cececeff"}},legend:{position:"right",layout:"vertical",itemName:{style:{fill:"#adadadff",fontSize:12}}},interactions:[{type:"element-selected"},{type:"element-active"}],statistic:{title:{style:{fontSize:"10px",color:"#b9b9b9ff",fontWeight:300},content:"总计",offsetY:-6},content:{style:{fontSize:"16px",color:"#c5c5c5ff"},content:"100",offsetY:2,offsetX:-2}},animation:{appear:{animation:"wave-in",duration:3000}},color:["#0087ffff","#339effff","#87c5ffff","#4687c3ff"]},data:{sourceType:'static',staticData:data}};}}/* harmony default export */ const pie_AntdPieDefinition = (AntdPieDefinition);
