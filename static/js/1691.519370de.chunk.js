"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([[1691,7556,868,4078,3702],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AntdColumnCommonFieldMapping: () => (/* binding */ AntdColumnCommonFieldMapping),
/* harmony export */   AntdColumnCommonStyleConfig: () => (/* binding */ AntdColumnCommonStyleConfig),
/* harmony export */   AntdColumnGraphics: () => (/* binding */ AntdColumnGraphics)
/* harmony export */ });
...
class AntdColumnCommonStyleConfig extends react__WEBPACK_IMPORTED_MODULE_0__.Component{constructor(){super(...arguments);this.barGraphicsChange=config=>{const controller=this.props.controller;controller.update({style:config});};this.barCoordinateSysChange=config=>{const controller=this.props.controller;controller.update({style:config});};}render(){const{controller}=this.props;const config=controller.getConfig().style;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.Fragment,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(AntdColumnGraphics,{onChange:this.barGraphicsChange,config:config}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_config_legend_AntdLegend__WEBPACK_IMPORTED_MODULE_3__.AntdLegend,{controller:controller}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_config_AntdFragment__WEBPACK_IMPORTED_MODULE_1__.AntdCartesianCoordinateSys,{onChange:this.barCoordinateSysChange,config:config})]});}}const AntdColumnGraphics=_ref=>{var _config$columnStyle;let{config,onChange}=_ref;const onFieldChange=fieldChangeData=>{const{id,data,dataFragment}=fieldChangeData;if(id==='columnColor'){if(data&&Array.isArray(data)){//多色
onChange({color:data,columnStyle:{fill:undefined}});}else if(data&&typeof data==='string'&&data.indexOf('gradient')!==-1){//渐变
}else{//单色
onChange({columnStyle:{fill:data}});}}else{onChange(dataFragment);}};const schema={type:'accordion',label:'图形',children:[{type:'grid',config:{columns:2},children:[{key:'maxColumnWidth',type:'number-input',label:'宽度',value:12,config:{min:0,max:100}},{key:'columnStyle',children:[{key:'radius',type:'number-input',label:'圆角',value:config===null||config===void 0?void 0:(_config$columnStyle=config.columnStyle)===null||_config$columnStyle===void 0?void 0:_config$columnStyle.radius,config:{min:1,max:100}}]},{id:'columnColor',type:'color-mode',label:'颜色',value:'#1c1c1c',config:{containerStyle:{gridColumn:'1/3'}}}]}]};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_json_schema_LCGUI__WEBPACK_IMPORTED_MODULE_2__.LCGUI,{schema:schema,onFieldChange:onFieldChange});};const AntdColumnCommonFieldMapping=props=>{const{controller}=props;const{xField,yField,seriesField}=controller.getConfig().style;const options=_AntdCommonUtil__WEBPACK_IMPORTED_MODULE_5__["default"].getDataFieldOptions(controller);const schema={key:'style',type:'grid',config:{columns:2},children:[{key:'xField',type:'select',label:'X字段',value:xField,config:{options}},{key:'yField',type:'select',label:'Y字段',value:yField,config:{options}},{key:'seriesField',type:'select',label:'分组字段',value:seriesField,config:{options}}]};const onFieldChange=fieldChangeData=>{const{dataFragment}=fieldChangeData;controller.update(dataFragment);};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_json_schema_LCGUI__WEBPACK_IMPORTED_MODULE_2__.LCGUI,{schema:schema,onFieldChange:onFieldChange});};
