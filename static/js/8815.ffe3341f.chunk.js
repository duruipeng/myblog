"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([[8815,7556],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AntdRadialBarFieldMapping: () => (/* binding */ AntdRadialBarFieldMapping),
/* harmony export */   "default": () => (/* binding */ AntdBaseRadialBarStyleConfig)
/* harmony export */ });
...
/* harmony import */ var _antd_common_AntdCommonUtil__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(97556);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7579);
function AntdBaseRadialBarStyleConfig(props){var _config$xAxis,_config$barStyle,_label$style,_label$style2,_label$style3;const{controller}=props;const config=controller.getConfig().style;const label=config===null||config===void 0?void 0:(_config$xAxis=config.xAxis)===null||_config$xAxis===void 0?void 0:_config$xAxis.label;const schema=[{type:'card-panel',label:'图形',children:[{type:'grid',key:'style',config:{columns:2},children:[{type:'number-input',key:'radius',label:'外径',config:{min:0.1,max:1,step:0.01},value:config===null||config===void 0?void 0:config.radius},{type:'number-input',key:'innerRadius',label:'内径',config:{min:0.1,max:1,step:0.01},value:config===null||config===void 0?void 0:config.innerRadius},{type:'number-input',key:'maxBarWidth',label:'柱宽',config:{min:0},value:config===null||config===void 0?void 0:config.maxBarWidth},{key:'barStyle',children:[{type:'select',key:'lineCap',label:'圆角',value:config===null||config===void 0?void 0:(_config$barStyle=config.barStyle)===null||_config$barStyle===void 0?void 0:_config$barStyle.lineCap,config:{options:[{label:'圆角',value:'round'},{label:'直角',value:'butt'}]}}]},{type:'color-mode',key:'color',label:'颜色',config:{containerStyle:{gridColumn:'1/3'}},value:config===null||config===void 0?void 0:config.color},{type:'number-input',key:'startAngle',label:'起始角度',id:'startAngle',config:{step:1,suffix:'°'},value:((config===null||config===void 0?void 0:config.startAngle)||0)/Math.PI*180},{type:'number-input',key:'endAngle',label:'起始角度',id:'startAngle',config:{step:1,suffix:'°'},value:((config===null||config===void 0?void 0:config.endAngle)||0)/Math.PI*180},{type:'number-input',key:'maxAngle',label:'最大旋角',config:{min:-360,max:360,step:1,suffix:'°'},value:config===null||config===void 0?void 0:config.maxAngle},{type:'select',key:'type',label:'图形类型',config:{options:[{label:'线形',value:'line'},{label:'柱形',value:''}]},value:config===null||config===void 0?void 0:config.type}]}]},{type:'card-panel',label:'文本',key:'style',children:[{type:'grid',key:'xAxis',config:{columns:2},children:[{key:'label',children:[{key:'rotate',type:'number-input',label:'角度',value:label.rotate||0,config:{min:0,step:0.1,max:360}},{key:'offset',type:'number-input',label:'偏移',value:label.offset||0},{key:'style',children:[{key:'fontSize',type:'number-input',label:'字号',value:((_label$style=label.style)===null||_label$style===void 0?void 0:_label$style.fontSize)||12,config:{min:1,max:50}},{key:'fontWeight',type:'number-input',label:'粗细',value:((_label$style2=label.style)===null||_label$style2===void 0?void 0:_label$style2.fontWeight)||500,config:{min:100,step:100,max:900}},{key:'fill',type:'color-picker',label:'颜色',value:((_label$style3=label.style)===null||_label$style3===void 0?void 0:_label$style3.fill)||'#1c1c1c',config:{showText:true}}]}]}]}]}];const onFieldChange=fieldChangeData=>{let{dataFragment,data,id}=fieldChangeData;if(id==='startAngle'){controller.update({style:{startAngle:data/180*Math.PI}});}else{controller.update(dataFragment);}};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_json_schema_LCGUI__WEBPACK_IMPORTED_MODULE_1__.LCGUI,{schema:schema,onFieldChange:onFieldChange});}const AntdRadialBarFieldMapping=_ref=>{var _controller$config;let{controller}=_ref;const config=(_controller$config=controller.config)===null||_controller$config===void 0?void 0:_controller$config.style;const options=_antd_common_AntdCommonUtil__WEBPACK_IMPORTED_MODULE_3__["default"].getDataFieldOptions(controller);const schema={type:'grid',key:'style',config:{columns:2},children:[{type:'select',key:'xField',label:'x字段',value:config===null||config===void 0?void 0:config.xField,config:{options}},{type:'select',key:'yField',label:'y字段',value:config===null||config===void 0?void 0:config.yField,config:{options}}]};const onFieldChange=fieldChangeData=>{controller.update(fieldChangeData.dataFragment);};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(_json_schema_LCGUI__WEBPACK_IMPORTED_MODULE_1__.LCGUI,{schema:schema,onFieldChange:onFieldChange});};
