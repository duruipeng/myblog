"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([[2642,9901,9141,1912,7941],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ rose_stack_AntdStackRoseDefinition)
});

;// CONCATENATED MODULE: ./src/pages/Charts/comps/antd/rose-stack/stack-rose.png
const stack_rose_namespaceObject = __webpack_require__.p + "static/media/stack-rose.8ee9ae5b4a95c1e52685.png";
// EXTERNAL MODULE: ./src/pages/Charts/comps/antd-common/rose/AbstractRoseDefinition.ts
var AbstractRoseDefinition = __webpack_require__(21912);
;// CONCATENATED MODULE: ./src/pages/Charts/comps/antd/rose-stack/AntdStackRoseDefinition.ts
class AntdStackRoseDefinition extends AbstractRoseDefinition["default"]{getBaseInfo(){return{compName:"Antd堆叠玫瑰图",compKey:"AntdStackRose",categorize:"chart",subCategorize:"rose"};}getChartImg(){return stack_rose_namespaceObject;}getInitConfig(){const data=[{type:'sort1',value:27,user:'user1'},{type:'sort2',value:25,user:'user1'},{type:'sort3',value:18,user:'user1'},{type:'sort4',value:15,user:'user1'},{type:'sort5',value:10,user:'user1'},{type:'sort1',value:7,user:'user2'},{type:'sort2',value:5,user:'user2'},{type:'sort3',value:28,user:'user2'},{type:'sort4',value:15,user:'user2'},{type:'sort5',value:20,user:'user2'}];return{base:{id:"",name:'Antd堆叠玫瑰图',type:'AntdStackRose'},style:{data:data,xField:"type",yField:"value",isStack:true,seriesField:"user",color:["#00b7ffff","#8ed2ffff"],radius:1,innerRadius:0,supportCSSTransform:true,sectorStyle:{stroke:"#fff",lineWidth:0},label:{offset:-12,style:{fill:"#ffffffff",fontSize:9,fontWeight:700}},legend:{position:"top",layout:"horizontal",itemName:{style:{fill:"#b9b9b9ff",fontSize:12}}},animation:{appear:{animation:"wave-in",duration:3000}}},data:{sourceType:'static',staticData:data}};}}/* harmony default export */ const rose_stack_AntdStackRoseDefinition = (AntdStackRoseDefinition);
