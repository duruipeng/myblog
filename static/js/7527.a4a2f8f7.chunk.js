"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([[7527,9901,9141,722,2135],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ line_multi_AntdMultiLineDefinition)
});

;// CONCATENATED MODULE: ./src/pages/Charts/comps/antd/line-multi/multi-line.png
const multi_line_namespaceObject = __webpack_require__.p + "static/media/multi-line.44c4faa6a8f4196c03de.png";
// EXTERNAL MODULE: ./src/pages/Charts/comps/antd-common/line/AbstractLineDefinition.ts
var AbstractLineDefinition = __webpack_require__(90722);
// EXTERNAL MODULE: ./src/pages/Charts/comps/antd/line-multi/AntdMultiLineConfig.tsx
var AntdMultiLineConfig = __webpack_require__(60287);
;// CONCATENATED MODULE: ./src/pages/Charts/comps/antd/line-multi/AntdMultiLineDefinition.ts
class AntdMultiLineDefinition extends AbstractLineDefinition["default"]{getBaseInfo(){return{compName:"Antd多折线图",compKey:"AntdMultiLine",categorize:"chart",subCategorize:"line"};}getChartImg(){return multi_line_namespaceObject;}getMenuToConfigContentMap(){const menuToConfigContentMap=super.getMenuToConfigContentMap();menuToConfigContentMap['style']=AntdMultiLineConfig["default"];menuToConfigContentMap['mapping']=AntdMultiLineConfig.AntdMultiLineFieldMapping;return menuToConfigContentMap;}getInitConfig(){const data=[{year:"2007",value:1706,category:"sort1"},{year:"2007",value:448,category:"sort2"},{year:"2008",value:1361,category:"sort1"},{year:"2008",value:779,category:"sort2"},{year:"2009",value:1722,category:"sort1"},{year:"2009",value:430,category:"sort2"},{year:"2010",value:1626,category:"sort1"},{year:"2010",value:555,category:"sort2"}];return{base:{id:"",name:'多折线图',type:'AntdMultiLine'},style:{data:data,xField:"year",yField:"value",seriesField:"category",supportCSSTransform:true,color:["#00a8ff","#00ffc9"],point:{color:["#00a8ff","#00ffc9"],size:3,shape:"circle",style:{stroke:"#00a8ff",lineWidth:0}},lineStyle:{lineWidth:2},xAxis:{grid:null,label:{style:{fill:"#969696ff",fontSize:11}},line:null,tickLine:null,subTickLine:null,position:"left",title:null},yAxis:{grid:null,label:{style:{fill:"#a0a0a0ff",fontSize:10}},line:{style:{stroke:"#adadad75",lineWidth:1}},tickLine:null,subTickLine:null,position:"bottom",title:null},smooth:false,legend:{position:"top",layout:"horizontal",itemName:{style:{fill:"#a0a0a0ff",fontSize:12}}},animation:{appear:{animation:"wave-in",duration:3000}}},data:{sourceType:'static',staticData:data}};}}/* harmony default export */ const line_multi_AntdMultiLineDefinition = (AntdMultiLineDefinition);
