"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([[287,7556,868,4078,3702],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AntdMultiLineFieldMapping: () => (/* binding */ AntdMultiLineFieldMapping),
/* harmony export */   AntdMultiLineGraphics: () => (/* binding */ AntdMultiLineGraphics),
/* harmony export */   "default": () => (/* binding */ AntdMultiLineStyleConfig)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(48331);
/* harmony import */ var _json_schema_LCGUI__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(45818);
/* harmony import */ var _antd_common_config_AntdFragment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10868);
/* harmony import */ var _antd_common_config_legend_AntdLegend__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(93702);
...
function AntdMultiLineStyleConfig(props){const{controller}=props;const config=controller.getConfig().style;const lineCoordinateSysChange=config=>{controller.update({style:config});};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.Fragment,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(AntdMultiLineGraphics,{controller:controller}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_antd_common_config_legend_AntdLegend__WEBPACK_IMPORTED_MODULE_3__.AntdLegend,{controller:controller}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_antd_common_config_AntdFragment__WEBPACK_IMPORTED_MODULE_2__.AntdCartesianCoordinateSys,{onChange:lineCoordinateSysChange,config:config})]});}const AntdMultiLineGraphics=props=>{var _config$lineStyle,_config$point,_config$point2,_config$point3,_config$point3$style,_config$point4,_config$point4$style,_config$point5;const{controller}=props;const config=controller.getConfig().style;const onFieldChange=fieldChangeData=>{const{dataFragment}=fieldChangeData;controller.update(dataFragment);};const schema={type:'accordion',label:'图形',key:'style',config:{bodyStyle:{marginTop:10}},children:[{type:'card-panel',label:'线条',children:[{type:'grid',config:{columns:2},children:[{key:'smooth',type:'switch',label:'平滑',value:config===null||config===void 0?void 0:config.smooth},{key:'lineStyle',children:[{key:'lineWidth',type:'number-input',label:'宽度',value:config===null||config===void 0?void 0:(_config$lineStyle=config.lineStyle)===null||_config$lineStyle===void 0?void 0:_config$lineStyle.lineWidth,config:{min:0,max:10}}]},{key:'color',type:'color-mode',label:'颜色',value:config===null||config===void 0?void 0:config.color,config:{containerStyle:{gridColumn:'1/3'}}}]}]},{type:'card-panel',label:'数据点',children:[{key:'point',type:'grid',config:{columns:2},children:[{key:'size',type:'number-input',label:'尺寸',value:config===null||config===void 0?void 0:(_config$point=config.point)===null||_config$point===void 0?void 0:_config$point.size,config:{min:0,max:10}},{key:'color',type:'color-mode',label:'颜色',value:config===null||config===void 0?void 0:(_config$point2=config.point)===null||_config$point2===void 0?void 0:_config$point2.color,config:{containerStyle:{gridColumn:'1/3'}}},{key:'style',children:[{key:'lineWidth',type:'number-input',label:'描边宽',value:config===null||config===void 0?void 0:(_config$point3=config.point)===null||_config$point3===void 0?void 0:(_config$point3$style=_config$point3.style)===null||_config$point3$style===void 0?void 0:_config$point3$style.lineWidth,config:{min:0}},{key:'stroke',type:'color-picker',label:'描边色',value:config===null||config===void 0?void 0:(_config$point4=config.point)===null||_config$point4===void 0?void 0:(_config$point4$style=_config$point4.style)===null||_config$point4$style===void 0?void 0:_config$point4$style.stroke,config:{showText:true}}]},{key:'shape',type:'select',label:'形状',value:config===null||config===void 0?void 0:(_config$point5=config.point)===null||_config$point5===void 0?void 0:_config$point5.shape,config:{options:[{value:'circle',label:'圈形'},{value:'square',label:'方形'},{value:'bowtie',label:'领结'},{value:'diamond',label:'钻石'},{value:'hexagon',label:'六角形'},{value:'triangle',label:'三角形'}]}}]}]}]};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_json_schema_LCGUI__WEBPACK_IMPORTED_MODULE_1__.LCGUI,{schema:schema,onFieldChange:onFieldChange});};const AntdMultiLineFieldMapping=_ref=>{var _controller$getConfig;let{controller}=_ref;const options=_antd_common_AntdCommonUtil__WEBPACK_IMPORTED_MODULE_5__["default"].getDataFieldOptions(controller);const{xField,yField,seriesField}=(_controller$getConfig=controller.getConfig())===null||_controller$getConfig===void 0?void 0:_controller$getConfig.style;const schema={type:'grid',key:'style',config:{columns:2},children:[{key:'xField',value:xField,type:'select',label:'X字段',config:{options}},{value:yField,key:'yField',type:'select',label:'Y字段',config:{options}},{value:seriesField,key:'seriesField',type:'select',label:'分组字段',config:{options}}]};const onFieldChange=fieldChangeData=>{const{dataFragment}=fieldChangeData;controller.update(dataFragment);};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_json_schema_LCGUI__WEBPACK_IMPORTED_MODULE_1__.LCGUI,{schema:schema,onFieldChange:onFieldChange});};
