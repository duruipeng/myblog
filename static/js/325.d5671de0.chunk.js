"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([[325,7556,868,4078,3702],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AntdAreaCommonFieldMapping: () => (/* binding */ AntdAreaCommonFieldMapping),
/* harmony export */   AntdAreaCommonStyleConfig: () => (/* binding */ AntdAreaCommonStyleConfig),
/* harmony export */   AntdCommonAreaGraphics: () => (/* binding */ AntdCommonAreaGraphics)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(48331);
/* harmony import */ var _config_AntdFragment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10868);
/* harmony import */ var _json_schema_LCGUI__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(45818);
/* harmony import */ var _AntdCommonUtil__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(97556);
/* harmony import */ var _config_legend_AntdLegend__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(93702);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7579);
class AntdAreaCommonStyleConfig extends react__WEBPACK_IMPORTED_MODULE_0__.Component{constructor(){super(...arguments);this.areaCoordinateSysChange=config=>{const controller=this.props.controller;controller.update({style:config});};}render(){var _controller$getConfig;const{controller}=this.props;const config=(_controller$getConfig=controller.getConfig())===null||_controller$getConfig===void 0?void 0:_controller$getConfig.style;return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.Fragment,{children:[/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(AntdCommonAreaGraphics,{controller:controller}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_config_legend_AntdLegend__WEBPACK_IMPORTED_MODULE_3__.AntdLegend,{controller:controller}),/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_config_AntdFragment__WEBPACK_IMPORTED_MODULE_1__.AntdCartesianCoordinateSys,{onChange:this.areaCoordinateSysChange,config:config})]});}}const AntdCommonAreaGraphics=props=>{var _controller$getConfig2,_config$point,_config$point2,_config$point3,_config$point3$style,_config$point4,_config$point4$style,_config$point5,_config$line,_config$line$style,_config$line2;const{controller}=props;const config=(_controller$getConfig2=controller.getConfig())===null||_controller$getConfig2===void 0?void 0:_controller$getConfig2.style;const _onChange=fieldChangeData=>{controller.update(fieldChangeData.dataFragment);};const schema={type:'accordion',label:'图形',key:'style',config:{bodyStyle:{marginTop:10}},children:[{type:'card-panel',label:'数据点',key:'point',children:[{type:'grid',config:{columns:2},children:[{key:'size',type:'number-input',label:'尺寸',value:(config===null||config===void 0?void 0:(_config$point=config.point)===null||_config$point===void 0?void 0:_config$point.size)||0,config:{min:0,max:100}},{key:'shape',type:'select',label:'形状',value:(config===null||config===void 0?void 0:(_config$point2=config.point)===null||_config$point2===void 0?void 0:_config$point2.shape)||'circle',config:{options:[{value:'circle',label:'圈形'},{value:'square',label:'方形'},{value:'bowtie',label:'领结'},{value:'diamond',label:'钻石'},{value:'hexagon',label:'六角形'},{value:'triangle',label:'三角形'}]}},{key:'style',children:[{key:'lineWidth',type:'number-input',label:'描边宽',value:config===null||config===void 0?void 0:(_config$point3=config.point)===null||_config$point3===void 0?void 0:(_config$point3$style=_config$point3.style)===null||_config$point3$style===void 0?void 0:_config$point3$style.lineWidth,config:{min:0}},{key:'stroke',type:'color-picker',label:'描边色',value:config===null||config===void 0?void 0:(_config$point4=config.point)===null||_config$point4===void 0?void 0:(_config$point4$style=_config$point4.style)===null||_config$point4$style===void 0?void 0:_config$point4$style.stroke,config:{showText:true}}]},{key:'color',type:'color-mode',label:'颜色',value:(config===null||config===void 0?void 0:(_config$point5=config.point)===null||_config$point5===void 0?void 0:_config$point5.color)||'#1c1c1c',config:{containerStyle:{gridColumn:'1/3'}}}]}]},{type:'card-panel',label:'数据线',children:[{type:'grid',config:{columns:2},children:[{key:'smooth',type:'switch',label:'平滑',value:(config===null||config===void 0?void 0:config.smooth)||false},{key:'line',children:[{key:'style',children:[{key:'lineWidth',type:'number-input',label:'宽度',value:(config===null||config===void 0?void 0:(_config$line=config.line)===null||_config$line===void 0?void 0:(_config$line$style=_config$line.style)===null||_config$line$style===void 0?void 0:_config$line$style.lineWidth)||0,config:{min:0,max:100}}]},{key:'color',type:'color-mode',label:'颜色',value:(config===null||config===void 0?void 0:(_config$line2=config.line)===null||_config$line2===void 0?void 0:_config$line2.color)||'#fff',config:{containerStyle:{gridColumn:'1/3'}}}]}]}]},{type:'card-panel',label:'数据面',children:[{type:'grid',children:[{type:'color-mode',label:'颜色',key:'color',value:(config===null||config===void 0?void 0:config.color)||'#1c1c1c'}]}]}]};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_json_schema_LCGUI__WEBPACK_IMPORTED_MODULE_2__.LCGUI,{schema:schema,onFieldChange:_onChange});};const AntdAreaCommonFieldMapping=props=>{const{controller}=props;const config=controller.config.style;const options=_AntdCommonUtil__WEBPACK_IMPORTED_MODULE_5__["default"].getDataFieldOptions(controller);const schema={key:'style',type:'grid',config:{columns:2},children:[{key:'xField',type:'select',label:'X字段',value:config.xField,config:{options}},{key:'yField',type:'select',label:'Y字段',value:config.yField,config:{options}},{key:'seriesField',type:'select',label:'分组字段',value:config.seriesField,config:{options}}]};const onFieldChange=fieldChangeData=>{controller.update(fieldChangeData.dataFragment);};return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_json_schema_LCGUI__WEBPACK_IMPORTED_MODULE_2__.LCGUI,{schema:schema,onFieldChange:onFieldChange});};
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(48331);
/* harmony import */ var _axis_AxisConfig__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(44078);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(48331);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(85640);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _json_schema_LCGUI__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(45818);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7579);
const Accordion=/*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(()=>__webpack_require__.e(/* import() */ 7610).then(__webpack_require__.bind(__webpack_require__, 67610)));const Radio=/*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.lazy)(()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 63879)));/**
 * 轴线配置项
