"use strict";
(self["webpackChunknews"] = self["webpackChunknews"] || []).push([[5270,745,4956,7042],{
...
var BaseImageController = __webpack_require__(87042);
;// ./src/pages/Charts/comps/lc/base-image/baseImage.png
...
var BaseImageConfig = __webpack_require__(44956);
...
;// ./src/pages/Charts/comps/lc/base-image/BaseImageDefinition.ts
const BaseInfo=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 4295).then(__webpack_require__.bind(__webpack_require__, 76676)));const FilterConfig=/*#__PURE__*/react.lazy(()=>__webpack_require__.e(/* import() */ 2017).then(__webpack_require__.bind(__webpack_require__, 4398)));class BaseImageDefinition extends AbstractDesignerDefinition["default"]{getBaseInfo(){return{compName:"基础图片",compKey:"BaseImage",categorize:"media"};}getChartImg(){return baseImage_namespaceObject;}getController(){return BaseImageController["default"];}getInitConfig(){return{base:{id:"",name:'基础图片',type:'BaseImage'},style:{type:'online',localUrl:'',onLineUrl:'',opacity:1},filter:{enable:false,blur:0,brightness:1,contrast:1,opacity:1,saturate:1,hueRotate:0}};}getMenuList(){return super.getMenuList().filter(item=>item.key!=='theme'&&item.key!=='data');}getMenuToConfigContentMap(){return{base:BaseInfo,style:BaseImageConfig.BaseImageStyleConfig,filter:FilterConfig};}getEventList(){const events=super.getEventList();return events.concat([{id:"click",name:"点击时"}]);}}
